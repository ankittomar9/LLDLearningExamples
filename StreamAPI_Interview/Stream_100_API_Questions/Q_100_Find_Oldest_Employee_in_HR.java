...
public class Q_100_Find_Oldest_Employee_in_HR {
    ...
    new Employee(199, "Phyllis Vance", 24, "Female", "Sales", 2016, 11500.0)
       ...
       // 100. Find the Oldest Employee in the "HR" Department
         Employee oldestInHR=employeeList.stream()
         .filter(e->"HR".equals(e.department()))
         .max(Comparator.comparing(Employee::age))
         .orElse(null);

          System.out.println("Oldest in HR: " + oldestInHR);
    }
  }
