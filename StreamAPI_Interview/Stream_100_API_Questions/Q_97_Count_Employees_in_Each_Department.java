...
public class Q_97_Count_Employees_in_Each_Department {
    ...
    new Employee(199, "Phyllis Vance", 24, "Female", "Sales", 2016, 11500.0)
       ...
       // 97 Count Employees in Each Department, Sorted by Count (Descending)
          List<Map.Entry<String,Long>> sortedDeptCounts=employeeList.stream()
          .collect(Collectors.groupingBy(Employee::department,Collectors.counting()))
          .entrySet().stream()
          .sorted(Map.Entry.<String,Long> comparingByValue().reversed())
          .collect(Collectors.toList());

          System.out.println("Sorted  Dept Counts: "+ sortedDeptCounts);
    }
  }
