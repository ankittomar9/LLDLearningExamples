...
public class Q_99_Convert_Employee_List_of_a_Map_with_ID_as_Key {
    ...
    new Employee(199, "Phyllis Vance", 24, "Female", "Sales", 2016, 11500.0)
       ...
       //99. Convert Employee List to a Map with ID as Key
        Map<Integer,Employee> employeeMap=employeeList.stream()
        .collect(Collectors.toMap(Employee::id,e->e));

        System.out.println("Employee 122 is: " + employeeMap.get(122)); 
